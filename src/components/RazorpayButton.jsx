...
//         order_id: orderData.id, // Passed from backend
...
//           alert(result); // Display the server-side verification result

//           setIsProcessing(false); // Payment processing complete
//         },
//         prefill: {
//           name: "Test User",
...
//       // Debugging: Check if Razorpay object is available
//       if (window.Razorpay) {
//         console.log("Razorpay is available, opening the modal...");
//         const razorpay = new window.Razorpay(options);
//         razorpay.open(); // This should open the Razorpay modal
//       } else {
